        ...
        <dl className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3">
          <div className="flex flex-col items-start">
            ...
            <dd className="mt-2 leading-7 text-stone-500">
              They say that idea is worth nothing without the execution. That&apos;s why I decided
              to share them for free. No hidden fees or charges. No copyright.
            </dd>
          </div>
          <div className="flex flex-col items-start">
            <div className="aspect-square rounded-md bg-white/5 p-2 text-center text-xl text-white ring-1 ring-white/10">
          ...
          <div className="flex flex-col items-start">
            ...
            <dd className="mt-2 leading-7 text-stone-500">
              Would you like to resurrect one of the ideas? Ask me any question, and I&apos;ll do my
              best to answer. Want to built it together? That&apos;s even better!
            </dd>
          </div>
        </dl>
      </div>
