        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex-none rounded-md bg-amber-100 px-3.5 py-2.5 text-sm font-semibold text-stone-900 shadow-sm hover:bg-amber-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Subscribe
              </button>
            </div>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-stone-400">
                No one have time to refresh the page every day. Be the first one to know about
                freshly digged up ideas.
              </dd>
            </div>
            <div className="flex flex-col items-start">
              <div className="aspect-square rounded-md bg-white/5 p-2 text-center text-xl text-white ring-1 ring-white/10">
              ...
              <dd className="mt-2 leading-7 text-stone-400">
                Get direct access to the content that is not available on the main list. Explore
                even wider range of ideas.
              </dd>
            </div>
          </dl>
        </div>
